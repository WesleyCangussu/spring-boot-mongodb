...
import com.wesleycangussu.mongodb.dto.AuthorDTO;
import com.wesleycangussu.mongodb.dto.CommentDTO;
...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Vou viajar", "Viajar para são paulo", new AuthorDTO(maria));
